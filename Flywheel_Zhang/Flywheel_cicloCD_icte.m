...
%% EMULACION FLYWHEEL CON PMDCM - CICLO COMPLETO con descarga iout constante 30 A

load('Data_cicloCD_icte.mat');
...
xlabel('t [s]'); 
ylabel('P [W]');
legend('P_{mec}','P_{elec}','P_{ss}','Orientation','horizontal');
...
xlabel('t [s]'); 
ylabel('V[V] i[A]');
legend('V(t)','i(t)','Orientation','horizontal');
